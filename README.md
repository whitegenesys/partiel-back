Application FastAPI pour la météo Cette application utilise FastAPI pour interagir avec l'API OpenWeatherMap afin de récupérer et filtrer les données météorologiques pour une ville spécifique.
